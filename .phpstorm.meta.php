...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Applications/MAMP/htdocs/cleaning-service-atm/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./Applications/MAMP/htdocs/cleaning-service-atm/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'web','api',);
        registerArgumentsSet('routes', 'profile.edit','profile.update','profile.destroy',
'admin.dashboard','admin.cs.index','admin.cs.create','admin.cs.store','admin.cs.show',
'admin.cs.edit','admin.cs.update','admin.cs.destroy','admin.cs.toggle-status','admin.area.index',
'admin.area.create','admin.area.store','admin.area.show','admin.area.edit','admin.area.update',
'admin.area.destroy','admin.atm.index','admin.atm.create','admin.atm.store','admin.atm.show',
'admin.atm.edit','admin.atm.update','admin.atm.destroy','admin.monitoring.absensi','admin.monitoring.laporan',
'admin.monitoring.detail-laporan','admin.monitoring.laporan-harian','admin.inventory.index','admin.inventory.create','admin.inventory.store',
'admin.inventory.show','admin.inventory.edit','admin.inventory.update','admin.inventory.destroy','admin.inventory.tambah-stok',
'admin.inventory.kurangi-stok','admin.permintaan.index','admin.permintaan.show','admin.permintaan.approve','admin.permintaan.reject',
'koordinator.dashboard','cs.dashboard','cs.absensi.index','cs.absensi.create','cs.absensi.store',
'cs.absensi.show','cs.laporan.index','cs.laporan.create','cs.laporan.store','cs.laporan.show',
'cs.monitoring.absensi','cs.monitoring.laporan','cs.monitoring.detail-laporan','cs.permintaan.index','cs.permintaan.create',
'cs.permintaan.store','cs.permintaan.show','register','login','password.request','password.email','password.reset','password.store',
'verification.notice','verification.verify','verification.send','password.confirm',
'password.update','logout','storage.local',);
        registerArgumentsSet('views', 
'admin.area.create','admin.area.edit','admin.area.index','admin.area.show','admin.atm.create',
'admin.atm.edit','admin.atm.index','admin.atm.show','admin.cs.create','admin.cs.edit',
'admin.cs.index','admin.cs.show','admin.dashboard','admin.inventory.create','admin.inventory.edit',
'admin.inventory.index','admin.inventory.show','admin.monitoring.absensi','admin.monitoring.detail-laporan','admin.monitoring.laporan',
'admin.monitoring.laporan-harian','admin.permintaan.create','admin.permintaan.index','admin.permintaan.show','auth.confirm-password',
...
'components.responsive-nav-link','components.secondary-button','components.text-input','cs.absensi.create','cs.absensi.index',
'cs.absensi.show','cs.dashboard','cs.laporan.create','cs.laporan.index','cs.laporan.show',
'cs.permintaan.create','cs.permintaan.index','cs.permintaan.show','dashboard','koordinator.dashboard',
'koordinator.monitoring.absensi','koordinator.monitoring.detail-laporan','koordinator.monitoring.laporan','koordinator.monitoring.laporan-harian','layouts.app',
'layouts.app-dashboard','layouts.guest','layouts.navigation','profile.edit','profile.partials.delete-user-form',
